...
和暦・干支・和風月名・日付・日干支・和時計時刻(不定時法)・二十四節気・雑節をターミナルに表示します。補足情報 (stderr)に日の出、日の入り、朔望についてを表示します。　 
...
```
令和八年丙午歳 卯月 十七日辛酉 巳二つ 清明 [土用入り]
(日出04:06-日入17:15 今夜は朔)
```

おやつ時(未の刻)の場合:

```
おやつ 令和八年丙午歳 卯月 十七日辛酉 未三つ 清明 [土用入り]
(日出04:06-日入17:15 今夜は朔)
```
...
- CUI (ターミナルで動くコマンド)
- 表示項目: 和暦、干支、和風月名、日付、日干支、和時計時刻(不定時法)、二十四節気、雑節
...
あなたはこれを、フリーソフトウェア財団によって発行されたGNU一般公衆利用許諾書（バージョン3か、それ以降のバージョンのうちどれか）が定める条件の下で再頒布または改変することができます。
