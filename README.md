...
和暦・和風月名・日付・和時計時刻(不定時法)・二十四節気・雑節・干支をターミナルに表示します。
...
```
おやつ 令和八年 卯月 十七日 未三つ 清明 [土用入り] 丙午
(日出04:06-日入17:15)
...
- CUI (ターミナルで動くコマンド)
- 表示項目: 和暦、和風月名、日付、和時計時刻(不定時法)、二十四節気、雑節、干支
